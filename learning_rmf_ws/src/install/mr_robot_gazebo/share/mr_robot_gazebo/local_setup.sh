...
: ${AMENT_CURRENT_PREFIX:="/home/dream_hell/learning_rmf_ws/src/install/mr_robot_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mr_robot_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mr_robot_gazebo/environment/path.sh"
