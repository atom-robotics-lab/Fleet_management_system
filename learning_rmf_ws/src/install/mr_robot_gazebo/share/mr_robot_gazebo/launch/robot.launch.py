...
def generate_launch_description():
    ...
    params_file = get_package_share_directory("mr_robot_gazebo")+"config/params.yaml"
    ...
    nav2_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'params_file': os.path.join(get_package_share_directory("mr_robot_gazebo"), 'config/params.yaml')
        }.items()
    )
